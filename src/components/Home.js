      ...
      <div>
        ...
        <div className="projects">
          <div className="inside-project">
            ...
            <div className='square-container'>
              <ProjectBlock source='/img/mywebsite.png' info='I developed this personal website using React.js. Previous iterations of my personal web page have been made with Gatsby.' url='https://github.com/Azbo400/Azbo400.github.io'/>
              ...
              <ProjectBlock source='/img/react-redux-authentication.png' info='React Redux Authentication Biolerplate is a biolerplate application I developed that allows users to create accounts, login, logout, etc using Redux and JSON web tokens.' url='https://github.com/Azbo400/react-redux-authentication-boilerplate'/>
              ...
              <ProjectBlock source='/img/blogapp.png'  info='My blog app is where I occasionally write articles about my programming life, tutorials, and what I am currently up too.' url='http://azbo400.github.io/Blog'/>
              <ProjectBlock source='/img/github.png' info='You can check out the rest of my projects on my GitHub page.' url='https://github.com/Azbo400/'/>
            </div>
          </div>
        </div>
        ...
        <div className="blog">
          <div className="blog-text">
            ...
            <Blog />
            <p>Read more of my articles on my blog page <a href="http://azbo400.github.io/Blog">here</a></p>
          </div>
        </div>
